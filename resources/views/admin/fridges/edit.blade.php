...
@section('content_header')
    <h1>Editar datos de Heladera</h1>
@stop
...
<p>Bienvenido a Administracion.</p>
    ...
    <div class="card">
        <div class="card-body">
            {!! Form::model($fridge, ['route' => ['admin.fridges.update', $fridge], 'method' => 'put']) !!}
            ...
            <div class="form-group">
                ...
                {!! Form::text('capability', NULL, ['class' => 'form-control', 'placeholder' => 'Capacidad de la Heladera']) !!}
            ...
            {!! Form::submit('Actualizar datos de la Heladera', ['class' => 'btn btn-primary']) !!}
        </div>
    </div>
@stop
