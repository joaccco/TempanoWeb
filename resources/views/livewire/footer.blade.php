<footer class="mx-auto w-full max-w-container px-4 sm:px-6 lg:px-8">
    <div class="border-t border-slate-900/5 py-10"></div>
        <img src="/img/logo.png" alt="" class="mx-auto h-40 w-auto text-slate-900" aria-hidden="true" viewBox="0 0 160 24" fill="none">
        ...
        <div class="mt-16 flex items-center justify-center space-x-4 text-sm font-semibold leading-6 text-slate-700">
            <a href="mailto:cisocorrientes@gmail.com">Mail</a>
