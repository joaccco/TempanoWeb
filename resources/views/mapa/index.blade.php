      ...
      <div class="bg-black text-white py-20">
        <div class="container mx-auto flex flex-col md:flex-row items-center my-12 md:my-24">
          <div class="flex flex-col w-full lg:w-1/3 justify-center items-start p-8">
            ...
            <a href="#map" class="mt-20 bg-transparent hover:bg-yellow-300 text-blue-700 hover:text-black rounded shadow hover:shadow-lg py-2 px-4 border border-blue-300 hover:border-transparent">Explorar</a>
          </div>
          <div class="p-8 mb-6 md:mb-0 md:mt-0 ml-0 md:ml-12 lg:w-2/3  justify-center">
            <div class="h-48 flex flex-wrap content-center">
              <div> 
                <img class="inline-block hidden xl:block" src="/img/puntos2.png">
              </div>
            </div>
          </div>
    </section>
